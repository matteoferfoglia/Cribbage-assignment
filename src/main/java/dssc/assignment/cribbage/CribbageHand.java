...
public class CribbageHand {
    ...
    private final List<Card> fourHandCards;
    // The starter card is an attribute of the game rather than a cribbage hand.

    public CribbageHand(List<Card> fourHandCards) {
        ...
        this.fourHandCards = new ArrayList<>(fourHandCards);
    }
    ...
    private static List<Card> convertCribbageHandFromStringRepresentationToListOfCards(String cribbageHandAsString) {
        List<Card> cribbageHandAsList = new ArrayList<>(cribbageHandAsString.length()/2);
    ...
    public List<Card> getFourHandCards() {
